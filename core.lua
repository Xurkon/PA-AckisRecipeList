...
function addon:OnInitialize()
	...
	-------------------------------------------------------------------------------
	local scan_button = CreateFrame("Button", nil, UIParent, "SharedButtonSmallTemplate")
...
do
	...
	function addon:TRADE_SKILL_SHOW()
		...
		if AscensionTradeSkillFrame then
			scan_button:SetParent(AscensionTradeSkillFrame)
			scan_button:ClearAllPoints()
			scan_button:SetPoint("LEFT", AscensionTradeSkillFrameCreateAllButton, "LEFT", -73, 0)
			scan_button:SetSize(70,AscensionTradeSkillFrameCreateAllButton:GetHeight())

		elseif scan_parent == TradeSkillFrame then
			scan_button:ClearAllPoints()
